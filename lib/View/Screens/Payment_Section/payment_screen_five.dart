...
import 'package:service_app/View/Screens/Payment_Section/payment_screen_six.dart';

class PaymentScreenFive extends StatefulWidget {
  const PaymentScreenFive({super.key});

  @override
  State<PaymentScreenFive> createState() => _PaymentScreenFiveState();
}

class _PaymentScreenFiveState extends State<PaymentScreenFive> {
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(child: PaymentScreenSix(), type: PageTransitionType.topToBottom,duration: Duration(milliseconds: 400)));                },
                child: Container(
                  height: 50,
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
