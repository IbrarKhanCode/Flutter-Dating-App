...
import 'package:service_app/View/Screens/Payment_Section/payment_screen_four.dart';

class PaymentScreenThree extends StatefulWidget {
  const PaymentScreenThree({super.key});

  @override
  State<PaymentScreenThree> createState() => _PaymentScreenThreeState();
}

class _PaymentScreenThreeState extends State<PaymentScreenThree> {
  @override
            ...
            children: [
              ...
              Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.paypal,color: primaryColor,),
                        SizedBox(width: 10,),
                        Text('PayPal'),
                        Spacer(),
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(child: PaymentScreenFour(), type: PageTransitionType.topToBottom,duration: Duration(milliseconds: 400)));                },
                child: Container(
                  height: 50,
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
