...
import 'package:service_app/View/Screens/Payment_Section/payment_screen_five.dart';

class PaymentScreenFour extends StatefulWidget {
  const PaymentScreenFour({super.key});

  @override
  State<PaymentScreenFour> createState() => _PaymentScreenFourState();
}

class _PaymentScreenFourState extends State<PaymentScreenFour> {
  @override
        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(child: PaymentScreenFive(), type: PageTransitionType.topToBottom,duration: Duration(milliseconds: 400)));                },
                child: Container(
                  height: 50,
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
