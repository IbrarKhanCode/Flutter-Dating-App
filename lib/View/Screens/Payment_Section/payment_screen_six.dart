...
import 'package:service_app/View/Screens/Payment_Section/payment_screen_seven.dart';

class PaymentScreenSix extends StatefulWidget {
  const PaymentScreenSix({super.key});

  @override
  State<PaymentScreenSix> createState() => _PaymentScreenSixState();
}

class _PaymentScreenSixState extends State<PaymentScreenSix> {
  @override
            ...
            children: [
              ...
              Container(
                  ...
                  child: Padding(
                    ...
                    child: Row(
                      children: [
                        Icon(Icons.food_bank_outlined,color: primaryColor,),
                        SizedBox(width: 10,),
                        Text('Net Banking' ),
                        Spacer(),
              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(context, PageTransition(child: PaymentScreenSeven(), type: PageTransitionType.topToBottom,duration: Duration(milliseconds: 400)));               },
                child: Container(
                  height: 50,
                  width: MediaQuery.of(context).size.width,
                  decoration: BoxDecoration(
